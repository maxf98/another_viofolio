...
export default function Page() {
  return (
    <div className="bg-[#24242e]">
      ...
      <div id="breathe" className="relative pt-24 pb-32" style={{ clipPath: "inset(0)" }}>
        ...
        <div className="content-container flex flex-col justify-center items-center">
          ...
          <div className="my-16 max-w-2xl text-center">
            <p>This cover explores breath as a force. My work involved illustration and collage, designing a hand-drawn title, a frame-by-frame animation in Procreate, and a full CD design.</p>
          </div>
          ...
          <h2 className="text-lg font-light mb-8 opacity-70">Animation & CD Design</h2>
      ...
      >
        ...
        <div className="content-container flex flex-col justify-center items-center gap-8">
          ...
          <div className="my-16 max-w-2xl text-center">
            <p>This cover design involved bringing Mascha into a calm underwater world. Working with photographs, this cover involved mainly photo editing and collage work.</p>
          </div>
      ...
      >
        ...
        <div className="my-16 max-w-2xl text-center">
          <p>This cover design wrapped Mascha in a warm, glowing floral blanket. The work combined photo editing, collage, and illustration, along with hand-drawn lettering for the title.</p>
        </div>
      ...
      <div className="relative" style={{ clipPath: "inset(0)" }}>
        ...
        <div className="content-container py-32 flex flex-col items-center text-center">
          <p className="max-w-2xl text-lg">
            Working with Mascha allowed me to explore the intersection of music and visual art, translating emotion and sound into imagery through a blend of traditional and digital techniques.
          </p>
        </div>
      </div>
    </div>
