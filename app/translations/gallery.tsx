...
const translations = {
    ...
    sections: [
      {
        ...
        images: [
          { index: 0, image: galleryImages.illustratedPhotography[4], alt: "view" },
          { index: 1, image: galleryImages.illustratedPhotography[21], alt: "sun" },
          { index: 2, image: galleryImages.illustratedPhotography[17], alt: "grandpa" },
          { index: 4, image: galleryImages.illustratedPhotography[2], alt: "sunburn" },
          { index: 6, image: galleryImages.illustratedPhotography[14], alt: "wood" },
          { index: 9, image: galleryImages.illustratedPhotography[1], alt: "ship" },
          { index: 11, image: galleryImages.illustratedPhotography[10], alt: "ghosts" },
          { index: 12, image: galleryImages.illustratedPhotography[13], alt: "chat" },
          { index: 13, image: galleryImages.illustratedPhotography[8], alt: "thoughts" },
          { index: 14, image: galleryImages.illustratedPhotography[16], alt: "monster" },
          { index: 17, image: galleryImages.illustratedPhotography[0], alt: "fake" },
          { index: 18, image: galleryImages.illustratedPhotography[6], alt: "tree dude" },
          { index: 3, image: galleryImages.illustratedPhotography[9], alt: "looking" },
        ],
      },
      {
        id: "art-therapy",
  ...
  de: {
    ...
    monkeybrain: {
      ...
      description: "Entwickelt als meine Bachelorarbeit an der NABA Mailand in Grafikdesign und Art Direction verbindet dieses Projekt Mixed Media, illustrierte Fotografie und Bildbearbeitung mit Forschung zu menschlicher Psychologie und innerer Erfahrung und führt zu Monkey Brain, einem illustrierten Magazin für junge Erwachsene, das Bewusstsein durch narrativ geführte Bildwelten vermittelt.",
    ...
    sections: [
      {
        ...
        description:
          "Momentaufnahmen aus meiner Umgebung dienen als Ausgangspunkt für imaginative Bildwelten. Durch das Experimentieren mit Bearbeitung und Zeichnung entdecke ich neue Formen und Szenen und lasse alltägliche Momente zu etwas Unerwartetem werden.",
        images: [
          { index: 0, image: galleryImages.illustratedPhotography[4], alt: "view" },
          { index: 1, image: galleryImages.illustratedPhotography[21], alt: "sun" },
          { index: 2, image: galleryImages.illustratedPhotography[17], alt: "grandpa" },
      ...
      },
      {
        ...
        description:
          "Diese analogen Arbeiten erforschen Bildfindung durch physische Materialien und experimentelle Prozesse. Inspiriert von meinem kunsttherapeutischen Weg liegt der Fokus auf Intuition, Ausdruck und dem Reagieren auf die Materialien, wodurch der kreative Prozess bewusst dem Zufall geöffnet wird.",
        images: [
          ...
          { index: 10, image: galleryImages.artTherapy[9], alt: "dragon drawing", title: "Drache", description: "Eine intuitive Bildstudie, bei der durch spontane Markierungen und Weiterentwicklung wesenhafte Formen entstehen." },
          { index: 12, image: galleryImages.artTherapy[10], alt: "handpainting process", title: "Handpainting", description: "Bei dieser Methode wird Farbe direkt mit Händen und Fingern statt mit Pinseln aufgetragen. Durch Berührung, Druck und Bewegung entstehen organische Spuren, die anschließend beobachtet und zu Bildformen weiterentwickelt werden." },
          { index: 13, image: galleryImages.artTherapy[11], alt: "abdruck print technique", title: "Abdruck", description: "Ein Bild entsteht durch das Hören einer Geschichte und das Zeichnen dessen, was hängen bleibt. Prägnante Fragmente, Gefühle und Szenen werden in intuitive Spuren übersetzt und danach zur Komposition ausgearbeitet." },
    ...
    sections: [
      ...
      },
      {
        ...
        images: [
          ...
          { index: 8, image: galleryImages.artTherapy[7], alt: "puzzle collage", title: "Пазл-коллаж", description: "Это упражнение начинается с вырезания формы пазла из бумаги. Не зная заранее, как всё сложится, я интуитивно оформляю каждый фрагмент по отдельности, а затем соединяю их в неожиданную коллажную композицию — результат, который невозможно было бы нарисовать намеренно." },
          ...
          { index: 10, image: galleryImages.artTherapy[9], alt: "dragon drawing", title: "Дракон", description: "Интуитивное исследование образа, где похожие на существо формы возникают через спонтанные линии и дальнейшую доработку." },
          { index: 12, image: galleryImages.artTherapy[10], alt: "handpainting process", title: "Handpainting", description: "Этот метод основан на прямом нанесении краски руками и пальцами вместо кисти. Через касание, нажим и движение появляются органичные следы, которые затем развиваются в визуальные формы." },
          { index: 13, image: galleryImages.artTherapy[11], alt: "abdruck print technique", title: "Abdruck", description: "Изображение создается через прослушивание истории и рисование того, что в ней осталось с вами. Самые яркие фрагменты, эмоции и сцены переводятся в интуитивные линии и затем собираются в композицию." },
