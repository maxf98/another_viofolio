    ...
    sections: [
      {
        ...
        images: [
          ...
          { index: 16, image: galleryImages.illustratedPhotography[20], alt: "dogs", title: "Dogs", description: "A character-focused drawing study exploring personality through stylized canine forms." },
          ...
          { index: 19, image: galleryImages.illustratedPhotography[6], alt: "schadenfreude", title: "Schadenfreude", description: "A conceptual drawing exploring layered emotional contrast through character and gesture." },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        images: [
          ...
          { index: 16, image: galleryImages.illustratedPhotography[20], alt: "dogs", title: "Dogs", description: "Eine charakterorientierte Zeichenstudie, die Persönlichkeit über stilisierte Hundeformen untersucht." },
          ...
          { index: 19, image: galleryImages.illustratedPhotography[6], alt: "schadenfreude", title: "Schadenfreude", description: "Eine konzeptuelle Zeichnung, die emotionale Kontraste über Figur und Geste untersucht." },
        ],
      },
      {
        id: "traditional-media",
    ...
    sections: [
      {
        ...
        images: [
          ...
          { index: 16, image: galleryImages.illustratedPhotography[20], alt: "dogs", title: "Dogs", description: "Персонажное исследование, передающее характер через стилизованные собачьи формы." },
          ...
          { index: 19, image: galleryImages.illustratedPhotography[6], alt: "schadenfreude", title: "Schadenfreude", description: "Концептуальный рисунок, исследующий эмоциональный контраст через персонаж и жест." },
        ],
      },
      {
        id: "traditional-media",
